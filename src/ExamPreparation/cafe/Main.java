...
public class Main {
    public static void main(String[] args) {
        ...
        //Initialize entity
        Employee employee = new Employee("Alexander", 30, "Bulgaria"); //Print Employee
        System.out.println(employee); // Employee: Alexander, 30 from Bulgaria
        //Add Employee
        cafe.addEmployee(employee);
        //Remove Employee System.out.println(cafe.removeEmployee("Employee")); //false
        ...
        System.out.println(cafe.getCount()); // 3 System.out.println(cafe.removeEmployee("Anna")); // true
        System.out.println(cafe.report()); //Employees working at Cafe Costa: //Employee: Alexander, 30 from Bulgaria //Employee: Sara, 24 from UK
    }
}
